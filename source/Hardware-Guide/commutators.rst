...
Computators compatible with the Miniscope System are single channel coaxial. Motorized and passive versions exist, as well as versions with an additional optical channel for optical fibres.
